...
public class LibraryData extends RequestData{
	...
	private String bID = null;//图书id
	private String bName = null;//图书name
	private String bAuthor = null;//图书作者
	private String bPlace = null;//存储地点
	private int bStorage = 0;//图书储量
	private int bTotal = 0;
	private String intro=null;
	private int bNumber = 0;
	private int bFlag= 0;
	private int bLendNumber = 0;
	private String bLendDate = null;//借书日期
	private String bReturnDate = null;//还书日期
