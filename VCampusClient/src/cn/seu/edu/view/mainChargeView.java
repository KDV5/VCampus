...
public class mainChargeView {
	...
	int xOld = 0;
	int yOld = 0;
	public mainChargeView(Client Client,String id){
		this.client=Client;
		this.id=id;
		...
		ImageIcon im1 = new ImageIcon("images/quanyi.png");
		JButton m1=new JButton(im1);
		m1.setContentAreaFilled(false);
		m1.setBounds(5, 50, 160, 80);
		m1.setBorder(null);
		menu.add(m1);
		ImageIcon im2 = new ImageIcon("images/geren.png");
		...
		m1.addActionListener(new feedbackActionPerformed());
		m2.addActionListener(new mailActionPerformed());
