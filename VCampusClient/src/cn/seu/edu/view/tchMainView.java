...
import cn.seu.edu.EduView.TchCourListView;
import cn.seu.edu.EduView.TchGradeView;
import cn.seu.edu.EduView.TchRequirListView;
import cn.seu.edu.EduView.stuChooseView;
import cn.seu.edu.InfoView.InfoNewStuView;
import cn.seu.edu.InfoView.InfoNewTchView;
import cn.seu.edu.InfoView.InfoTchView;
...
import cn.seu.edu.view.stuMainView.LibActionPerformed;
import cn.seu.edu.view.stuMainView.changeActionPerformed;
import cn.seu.edu.view.stuMainView.LibActionPerformed.UserQueryAction;
import cn.seu.edu.view.stuMainView.LibActionPerformed.UserSearchAction;
import cn.seu.edu.view.stuMainView.infoActionPerformed.chanPasswordsAction;


public class tchMainView {
	...
	public tchMainView(Client Client,String id){
		this.client=Client;
		this.id=id;
		...
		JLabel mainback1=new JLabel(new ImageIcon("images/main5.png"));
		mainback1.setBounds(0, 0, 1100, 700);
		jl.add(mainback1, new Integer(100));
	...
	public class infoActionPerformed implements ActionListener{
		public void actionPerformed(ActionEvent e){
			 ...
			 s1.addActionListener(new InfoTchAction());
			 s2.addActionListener(new InfoNewTchAction());
			 s3.addActionListener(new chanPasswordsAction());
		}
		public class InfoTchAction implements ActionListener{
			public void actionPerformed(ActionEvent e){
				 jl.remove(mb);
				 main.removeAll();
				 jl.remove(main);
				 new InfoTchView(client,id,main);
		...
		public class InfoNewTchAction implements ActionListener{
			public void actionPerformed(ActionEvent e){
				 jl.remove(mb);
				 main.removeAll();
				 jl.remove(main);
				 new InfoNewTchView(client,id,main);
	             main.setBounds(0, 0, 1040, 700);
	             main.setLayout(null);
	             jl.add(main,new Integer(200));
	             tl.repaint();
	...
	//教务处
	 class eduActionPerformed implements ActionListener{
		 public void actionPerformed (ActionEvent e){
			 mb.removeAll();
			 jl.remove(mb);
			 ImageIcon ic1 = new ImageIcon("images/banji.png");
			 JButton s1=new JButton(ic1);
			 s1.setContentAreaFilled(false);
			 s1.setBounds(0, 0, 120, 40);
			 s1.setBorder(null);
			 mb.add(s1);
			 ImageIcon ic2 = new ImageIcon("images/shouke.png");
			 JButton s2=new JButton(ic2);
			 s2.setContentAreaFilled(false);
			 s2.setBounds(0, 50, 120, 40);
			 s2.setBorder(null);
			 mb.add(s2);
			 ImageIcon ic3 = new ImageIcon("images/xuesheng.png");
			 JButton s3=new JButton(ic3);
			 s3.setContentAreaFilled(false);
			 ...
			 s1.addActionListener(new TchGradeListener());
			 s2.addActionListener(new TchCourListListener());
			 s3.addActionListener(new TchRequirListListener());
			 
		 }
		 class TchGradeListener implements ActionListener{
			 public void actionPerformed (ActionEvent e){
				 jl.remove(mb);
				 main.removeAll();
				 jl.remove(main);
				 new TchGradeView(client,id,main);
		 ...
		 class TchCourListListener implements ActionListener{
			 public void actionPerformed (ActionEvent e){
				 jl.remove(mb);
				 main.removeAll();
				 jl.remove(main);
				 new TchCourListView(client,id,main);
		 ...
		 class TchRequirListListener implements ActionListener{
			 public void actionPerformed (ActionEvent e){
				 jl.remove(mb);
				 main.removeAll();
				 jl.remove(main);
				 new TchRequirListView(client,id,main);
				 main.setBounds(30, 30, 1040, 700);
				 main.setLayout(null);
	             jl.add(main,new Integer(200));
	             tl.repaint();
