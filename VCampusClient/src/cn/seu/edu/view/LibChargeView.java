...
import cn.seu.edu.LibView.ManDeleteView;
import cn.seu.edu.LibView.ManInsertView;
import cn.seu.edu.LibView.ManLendView;
import cn.seu.edu.LibView.ManReturnView;
...
public class LibChargeView {
	...
	int xOld = 0;
	int yOld = 0;
	public LibChargeView(Client Client,String id){
		this.client=Client;
		this.id=id;
		...
		m1.addActionListener(new ManDeleteActionPerformed());
		m2.addActionListener(new  ManInsertActionPerformed());
		m3.addActionListener(new ManLendActionPerformed());
		m4.addActionListener(new ManReturnActionPerformed());
		m5.addActionListener(new feedbackActionPerformed());
		m6.addActionListener(new mailActionPerformed());
	...
	//书籍删除
	public class ManDeleteActionPerformed implements ActionListener{
		public void actionPerformed(ActionEvent e){
				 main.removeAll();
				 jl.remove(main);
				 try {
					new ManDeleteView(client,main);
	...
	//书籍添加
	public class  ManInsertActionPerformed implements ActionListener{
		public void actionPerformed(ActionEvent e){
				 main.removeAll();
				 jl.remove(main);
				 try {
					new  ManInsertView(client,main);
				} catch (SQLException e1) {
					// TODO Auto-generated catch block
					e1.printStackTrace();
				}
	...
	//书籍外借
	public class ManLendActionPerformed implements ActionListener{
		public void actionPerformed(ActionEvent e){
				 main.removeAll();
				 jl.remove(main);
				 try {
					new ManLendView(client,main);
				} catch (SQLException e1) {
					// TODO Auto-generated catch block
					e1.printStackTrace();
				}
	...
	//书籍返还
	public class ManReturnActionPerformed implements ActionListener{
		public void actionPerformed(ActionEvent e){
				 main.removeAll();
				 jl.remove(main);
				 try {
					new ManReturnView(client,main);
				} catch (SQLException e1) {
					// TODO Auto-generated catch block
					e1.printStackTrace();
				}
