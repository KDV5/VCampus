...
public class ShopChargeView {
	...
	int xOld = 0;
	int yOld = 0;
	public ShopChargeView(Client Client,String id){
		this.client=Client;
		this.id=id;
		...
		m1.addActionListener(new AddNewGoodsActionPerformed());
		m2.addActionListener(new ChangeGoodsInfoActionPerformed());
		m3.addActionListener(new feedbackActionPerformed());
		m4.addActionListener(new mailActionPerformed());
	...
	//增加商品
	public class AddNewGoodsActionPerformed implements ActionListener{
		public void actionPerformed(ActionEvent e){
				 main.removeAll();
				 jl.remove(main);
	...
	public class  ChangeGoodsInfoActionPerformed implements ActionListener{
		public void actionPerformed(ActionEvent e){
				 main.removeAll();
				 jl.remove(main);
