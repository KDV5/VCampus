...
public class TchCourListView {

	Client client;
	String id;
	JPanel jFrame=new JPanel();
	public TchCourListView(Client client,String id,JPanel jp){
		this.client = client;
		this.id = id;
		this.jFrame=jp;
		
		IdData idata = new IdData("OutputTchCourList",id);
