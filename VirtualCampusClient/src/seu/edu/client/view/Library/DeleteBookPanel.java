...
public class DeleteBookPanel extends JPanel {
	...
	public DeleteBookPanel(SocketClient sc) {
		socketClient=sc;
		...
		searchButton.setIcon(new ImageIcon(DeleteBookPanel.class.getResource("/UI/Library/放大镜.png")));
		...
		backGround.setIcon(new ImageIcon(DeleteBookPanel.class.getResource("/UI/Library/Panel.png")));
